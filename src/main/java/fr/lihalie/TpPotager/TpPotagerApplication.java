...
public class TpPotagerApplication implements CommandLineRunner  {
	...
	public void run(String... args) throws Exception {
		...
		//Test insertion PDC 
		PlanteDansCarre pdc1 = new PlanteDansCarre(5, LocalDate.now(), LocalDate.of(2021, 10, 25), c2, pl2);
		managerPdc.addPdc(pdc1);
		managerPdc.getAllPdc().forEach(System.out::println);
